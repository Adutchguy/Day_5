...
function multiply(a,b){ //eslint-disable-line
  var numberProduct = a * b;
  var productString = 'The product of ' + a + ' and ' + b + ' is ' + numberProduct + '.';
...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  return [numberSum1[0],sumString,productString,numberProduct2[0]];
}
...
function sumArray(testArray){ //eslint-disable-line
  var firstTwoSum1 = sum(testArray[0],testArray[1]);
